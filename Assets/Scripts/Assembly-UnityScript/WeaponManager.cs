...
public class WeaponManager : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024ChangeWeapon_0024225 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal int _0024indx_0024226;

			internal WeaponManager _0024self__0024227;

			public _0024(int indx, WeaponManager self_)
			{
				_0024indx_0024226 = indx;
			...
			public override bool MoveNext()
			{
				...
				default:
					canFire = false;
					_0024self__0024227.currentWeapon = _0024indx_0024226;
					_0024self__0024227.GetComponent<Animation>().PlayQueued("GunDown", QueueMode.CompleteOthers);
					_0024self__0024227.GetComponent<Animation>().PlayQueued("GunUp");
					result = (Yield(2, new WaitForSeconds(0.5f)) ? 1 : 0);
					break;
				case 2:
					_0024self__0024227.SetActiveWeapon(_0024self__0024227.weapons[_0024indx_0024226]);
					_0024self__0024227.weapons[_0024indx_0024226].SendMessage("AddAmmo", _0024self__0024227.ammoToAdd[_0024indx_0024226]);
					_0024self__0024227.ammoToAdd[_0024indx_0024226] = 0;
					canFire = true;
					YieldDefault(1);
					goto case 1;
				case 1:
		...
		internal int _0024indx_0024228;

		internal WeaponManager _0024self__0024229;

		public _0024ChangeWeapon_0024225(int indx, WeaponManager self_)
		{
			_0024indx_0024228 = indx;
			_0024self__0024229 = self_;
		}

		public override IEnumerator<WaitForSeconds> GetEnumerator()
		{
			return new _0024(_0024indx_0024228, _0024self__0024229);
		}
	}
	...
	{
		return new _0024ChangeWeapon_0024225(indx, this).GetEnumerator();
	}
